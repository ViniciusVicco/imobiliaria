...
class UpdateBrokerPropertyStatusUseCase {
  UpdateBrokerPropertyStatusUseCase({required this.repository});
  ...
  Future<DualResponse<Failure, BrokerPropertyEntity>> call({
    ...
    return repository.updateBrokerStatus(id: id, status: status);
  }
}
